...
Below a visualisation of the ARCS codebase can be seen. Dots are files color-coded by file extension.
...
Additional packages:
- ```./ZED_SDK_Linux_*.run``` [download](https://download.stereolabs.com/zedsdk/3.5/jp44/jetsons) and run Zed SDK
